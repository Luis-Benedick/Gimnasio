	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-shopping-cart zmdi-hc-fw"></i> Actividades <small>Salón</small></h1>
			</div>
			<p class="lead">Registro y Lista de todos nuestros salones!</p>
		</div>
					<?php 
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form action="../vista/salon/registro.php" method="post" autocomplete="off">
									    	<div class="form-group label-floating">
											  <label class="control-label">Nombre del salon</label>
											  <input name="nomsalo" class="form-control" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" required="" type="text">
											</div>
		...
		foreach ($db->query($sql) as $row) {
			...
			<tr>
				...
				<td><?php echo $row['nomsalo']; ?></td>
						...
						<td>
			<a href="#ver_<?php echo $row["id_salon"]; ?>" title="Ver datos" data-backdrop="false" class="btn btn-primary btn-raised btn-xs" data-toggle="modal"><i class="zmdi zmdi-eye"></i></a>
			
			
			<a href="#delete_<?php echo $row["id_salon"]; ?>" title="Eliminar" data-backdrop="false" class="btn btn-danger btn-raised btn-xs" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
			
			<a href="#edit_<?php echo $row["id_salon"]; ?>" title="Editar" data-backdrop="false" class="btn btn-warning btn-raised btn-xs" data-toggle="modal"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
			<?php include('../vista/salon/Modalpassw.php'); ?>
